...
git remote add github https://$GITHUB_TOKEN@github.com/yiluxiangbei87110/input-number.git > /dev/null 2>&1
git push github HEAD:master --follow-tags

GREN_GITHUB_TOKEN=$GITHUB_TOKEN yarn release

url=https://api.github.com/repos/yiluxiangbei87110/input-number/releases/latest
...
msg='{"msgtype": "markdown", "markdown": {"title": "input-number更新", "text": "@所有人\n# [input-number('$version')]('$html_url')\n'$body'"}}'
